...
app.post("/api/addnewcar/", async function (req, res) {
  try {
    ...
    const contract = network.getContract("Carshowroom");
...
app.get("/api/querycarbyid/:id", async function (req, res) {
  try {
    // load the network configuration
    const ccpPath = path.resolve(
      __dirname,
...
app.put("/api/changecarownership/:id", async function (req, res) {
  try {
    // load the network configuration
    const ccpPath = path.resolve(
      __dirname,
